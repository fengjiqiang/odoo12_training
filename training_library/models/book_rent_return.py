...
class BookSentReturn(models.Model):
    ...
    address = fields.Char(related='customer_id.address', string="地址")
    email = fields.Char(related='customer_id.email', string="Email")
    phone = fields.Char(related='customer_id.phone', string="联系方式")
    rental_date = fields.Datetime(string="借阅时间", default=datetime.now(), track_visibility='always')
