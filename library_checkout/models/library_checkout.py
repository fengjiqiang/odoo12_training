...
class Checkout(models.Model):
    ...
    member_id = fields.Many2one('library.partner', required=True)
...
class CheckoutLine(models.Model):
    ...
    author = fields.Many2many(related='book_id.author_ids_ids')
    publish = fields.Many2one(related='book_id.publisher_id_id')
